...
echo "SALT_PAYMENT_PROCESSOR_CONFIGURATION: $SALT_PAYMENT_PROCESSOR_CONFIGURATION"
...
forge script script/common/DeployPaymentProcessorConfiguration.s.sol:DeployPaymentProcessorConfiguration \
  --gas-price $GAS_PRICE \
