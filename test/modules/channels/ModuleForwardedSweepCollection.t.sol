...
contract ModuleForwardedSweepCollectionTest is PaymentProcessorModuleTest {
    ...
    function _runTestSweepCollectionViaUntrustedChannelFails(
        bool cosigned,
        ...
        _setPaymentSettings(
            params1.paymentSettings,
            saleDetailsArray[0].itemPrice,
            saleDetailsArray[0].tokenAddress,
            params1.paymentMethod,
            0,
            address(0),
            0,
            address(0),
    ...
    function _runTestSweepCollectionViaTrustedChannelSucceeds(
        bool cosigned,
        bool isCosignatureEmpty,
        TestTradeSingleItemParams memory params1,
        TestTradeSingleItemParams memory params2
    ...
    function testForwardedSweepCollectionStandardNoFeeOnTop(
    ...
    function testForwardedSweepCollectionStandardFeeOnTop(
        uint8 paymentSettings, 
        uint8 orderProtocol,
        FuzzedOrder721 memory fuzzedOrderInputs1, 
        FuzzedOrder721 memory fuzzedOrderInputs2, 
    ...
    function testForwardedSweepCollectionStandardNoFeeOnTopCosigned(
        uint8 paymentSettings, 
        uint8 orderProtocol,
        FuzzedOrder721 memory fuzzedOrderInputs1, 
        FuzzedOrder721 memory fuzzedOrderInputs2, 
    ...
    function testForwardedSweepCollectionStandardFeeOnTopCosigned(
        uint8 paymentSettings, 
        uint8 orderProtocol,
        FuzzedOrder721 memory fuzzedOrderInputs1, 
        FuzzedOrder721 memory fuzzedOrderInputs2, 
    ...
    function testForwardedSweepCollectionStandardNoFeeOnTopEmptyCosigned(
        uint8 paymentSettings, 
        uint8 orderProtocol,
        FuzzedOrder721 memory fuzzedOrderInputs1, 
        FuzzedOrder721 memory fuzzedOrderInputs2, 
    ...
    function testForwardedSweepCollectionStandardFeeOnTopEmptyCosigned(
        uint8 paymentSettings, 
        uint8 orderProtocol,
        FuzzedOrder721 memory fuzzedOrderInputs1, 
        FuzzedOrder721 memory fuzzedOrderInputs2, 
    ...
    function testUntrustedForwarderFailsSweepCollectionStandardNoFeeOnTop(
        uint8 paymentSettings, 
        uint8 orderProtocol,
        FuzzedOrder721 memory fuzzedOrderInputs1, 
        FuzzedOrder721 memory fuzzedOrderInputs2, 
        ...
        paymentSettings = paymentSettings % 2;
        vm.assume(fuzzedOrderInputs1.itemPrice < type(uint96).max);
        vm.assume(fuzzedOrderInputs2.itemPrice < type(uint96).max);
        ...
        _runTestSweepCollectionViaUntrustedChannelFails(false, false, params1, params2);
    }
    ...
    function testTrustedForwarderSucceedsSweepCollectionStandardNoFeeOnTop(
        uint8 paymentSettings, 
        uint8 orderProtocol,
        FuzzedOrder721 memory fuzzedOrderInputs1, 
        FuzzedOrder721 memory fuzzedOrderInputs2, 
        ...
        _runTestSweepCollectionViaTrustedChannelSucceeds(false, false, params1, params2);
    }
}