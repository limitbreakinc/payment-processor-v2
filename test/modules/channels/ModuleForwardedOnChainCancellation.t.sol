...
contract ModuleForwardedOnChainCancellationTest is PaymentProcessorModuleTest {
    ...
    function testRevokeOrderDigest(address account, FuzzedOrder721 memory fuzzedOrderInputs, uint248 amount, uint248 fillAmount) public {
        ...
        _revokeOrderDigest(channel, account, digest, EMPTY_SELECTOR);
