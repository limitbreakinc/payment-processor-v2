...
contract ModuleAcceptItemOfferTest is cPortModuleTest {
    ...
    function testAcceptItemOffer721FillOrKillStandardNoFeeOnTop_WETH(FuzzedOrder721 memory fuzzedOrderInputs) public {
    ...
    function testAcceptItemOffer1155FillOrKillStandardNoFeeOnTop_WETH(FuzzedOrder721 memory fuzzedOrderInputs, uint248 amount) public {
        _scrubFuzzedOrderInputs(fuzzedOrderInputs);
        vm.assume(amount > 0);
    ...
    function testAcceptItemOffer1155FillPartialStandardNoFeeOnTop_WETH(FuzzedOrder721 memory fuzzedOrderInputs, uint248 amount, uint248 fillAmount) public {
        _scrubFuzzedOrderInputs(fuzzedOrderInputs);
        vm.assume(amount > 0);
    ...
    function testAcceptItemOffer721FillOrKillCosignedNoFeeOnTop_WETH(FuzzedOrder721 memory fuzzedOrderInputs) public {
        _scrubFuzzedOrderInputs(fuzzedOrderInputs);
    ...
    function testAcceptItemOffer1155FillOrKillCosignedNoFeeOnTop_WETH(FuzzedOrder721 memory fuzzedOrderInputs, uint248 amount) public {
        _scrubFuzzedOrderInputs(fuzzedOrderInputs);
        vm.assume(amount > 0);
    ...
    function testAcceptItemOffer1155FillPartialCosignedNoFeeOnTop_WETH(FuzzedOrder721 memory fuzzedOrderInputs, uint248 amount, uint248 fillAmount) public {
        _scrubFuzzedOrderInputs(fuzzedOrderInputs);
        vm.assume(amount > 0);
        vm.assume(fillAmount > 0);
        vm.assume(fillAmount < amount);
    ...
    function testAcceptItemOffer721FillOrKillEmptyCosignedNoFeeOnTop_WETH(FuzzedOrder721 memory fuzzedOrderInputs) public {
        _scrubFuzzedOrderInputs(fuzzedOrderInputs);
    ...
    function testAcceptItemOffer1155FillOrKillEmptyCosignedNoFeeOnTop_WETH(FuzzedOrder721 memory fuzzedOrderInputs, uint248 amount) public {
        _scrubFuzzedOrderInputs(fuzzedOrderInputs);
        vm.assume(amount > 0);
    ...
    function testAcceptItemOffer1155FillPartialEmptyCosignedNoFeeOnTop_WETH(FuzzedOrder721 memory fuzzedOrderInputs, uint248 amount, uint248 fillAmount) public {
        _scrubFuzzedOrderInputs(fuzzedOrderInputs);
        vm.assume(amount > 0);
        vm.assume(fillAmount > 0);
        vm.assume(fillAmount < amount);
